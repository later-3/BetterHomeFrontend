...
export interface Comment {
	...
	parent_type?: 'post' | 'announcement' | 'work_order' | 'work_order_node' | null;
...
export interface WorkOrderNode {
	...
	node_type?: 'submitted' | 'accepted' | 'in_progress' | 'resolved' | 'updated_by_submitter' | 'updated_by_assignee' | null;
...
export interface DirectusUser {
	...
	building_id?: Building | string | null;
	/** @required */
	user_type: 'resident' | 'property_manager' | 'committee_member' | 'admin' | 'property_woker' | 'committee_normal';
	policies?: DirectusAccess[] | string[];
}
